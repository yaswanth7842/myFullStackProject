        ...
        <div className="contact-card">
          <div className="icon-wrapper">
            <svg width="21" height="21" viewBox="0 0 21 21">
              <path
                fill="currentColor"
                d="M19 13.513l-4.415-1.98a1.87 1.87 0 0 0-1.886.243l-2.091 1.781c-1.22-.66-2.478-1.91-3.14-3.113l1.787-2.125a1.88 1.88 0 0 0 .148-1.782L7.488 2A1.88 1.88 0 0 0 5.539.89C4.687.562 3.707 1.133 4.128 2.81l1.925 6.66c.37 1.28 1.335 2.35 2.581 2.857l2.062-1.76a.935.935 0 0 1 .943-.122l4.415 1.98a.94.94 0 0 1 .634.882v2.537a.938.938 0 0 1-.914.94"
              />
            </svg>
          </div>
